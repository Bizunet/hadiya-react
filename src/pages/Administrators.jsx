...
import { LEADER, ADMINS, TEAM_FILTERS } from "../data/administrators";
      ...
      <section>
        <div className="wrap">
          <Reveal as="div" variant="scale" className="leader-feature">
            ...
            <div className="avatar-ph lg" style={{ position: "relative", zIndex: 1 }}>
          ...
          <Reveal as="div" className="section-head" style={{ marginBottom: 24 }}>
            ...
            <div className="admin-grid" data-stagger>
              {filtered.map((a, i) => (
                <Reveal as="div" variant="scale" delay={(i % 4) * 60} className="admin-card" key={a.key}>
                  <div className="avatar-ph md has-photo"><img src={a.photo} alt={a.nameEn} /></div>
